...
try:
    ...
    from lib.dulwich._compat import parse_qs
from lib.dulwich import log_utils
from lib.dulwich.protocol import (
    ReceivableProtocol,
    )
from lib.dulwich.repo import (
    Repo,
    )
from lib.dulwich.server import (
    DictBackend,
    DEFAULT_HANDLERS,
    )
