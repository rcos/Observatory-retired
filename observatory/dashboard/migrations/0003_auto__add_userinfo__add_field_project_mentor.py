...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dashboard_userinfo', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='info', unique=True, primary_key=True, to=orm['auth.User'])),
            ('mentor', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('dashboard', ['UserInfo'])

        # Adding field 'Project.mentor'
        db.add_column(u'dashboard_project', 'mentor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mentored', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserInfo'
        db.delete_table(u'dashboard_userinfo')

        # Deleting field 'Project.mentor'
        db.delete_column(u'dashboard_project', 'mentor_id')
