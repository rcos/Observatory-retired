...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.blog_warn_level'
        db.add_column(u'dashboard_project', 'blog_warn_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Project.repo_warn_level'
        db.add_column(u'dashboard_project', 'repo_warn_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.blog_warn_level'
        db.delete_column(u'dashboard_project', 'blog_warn_level')

        # Deleting field 'Project.repo_warn_level'
        db.delete_column(u'dashboard_project', 'repo_warn_level')
