...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emaillist_emailaddress', (
            ('address', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='emails', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'emaillist', ['EmailAddress'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'emaillist_emailaddress')
    ...
    models = {
        ...
        u'emaillist.emailaddress': {
            'Meta': {'object_name': 'EmailAddress'},
            'address': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200', 'primary_key': 'True'}),
